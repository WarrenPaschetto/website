  ...
  return (
    <div className="flex justify-center w-full bg-gray-100 rounded-lg shadow-lg dark:shadow-gray-900 dark:bg-gray-900 my-8 mx-auto">
      <div className="container text-center mx-auto my-10 max-w-[60%]">
        <Collapsible>
          <CollapsibleTrigger>
            <h1 className="text-3xl font-bold text-accent dark:text-text-primary-dark mb-8">{role === "trainer"? <div className="flex flex-row items-center hover:text-[#FCA311]">About Me as a Trainer&nbsp;&nbsp;<ChevronsUpDown className="stroke-accent dark:stroke-text-primary-dark hover:stroke-[#FCA311] dark:hover:stroke-[#FCA311] w-10 h-10"/> </div>: <div className="flex flex-row items-center hover:text-[#FCA311]">About Me as a Developer&nbsp;&nbsp;<ChevronsUpDown className="stroke-accent dark:stroke-text-primary-dark hover:stroke-[#FCA311] dark:hover:stroke-[#FCA311] w-10 h-10"/></div>}</h1>
          </CollapsibleTrigger>
        <CollapsibleContent>
          {role === "trainer"?
            <>
